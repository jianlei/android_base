...
public class UpdateChecker extends Fragment {
     ...
     */
    public static UpdateChecker checkForDialog(FragmentActivity fragmentActivity) {
     ...
     */
    public static UpdateChecker checkForNotification(FragmentActivity fragmentActivity) {
        FragmentTransaction content = fragmentActivity.getSupportFragmentManager().beginTransaction();
        UpdateChecker updateChecker = new UpdateChecker();
        Bundle args = new Bundle();
...
//		checkForUpdates();
    ...
    public void showNewVersionInfo(String updateMessage, String apkUrl) {

        if (mTypeOfNotice == NOTICE_NOTIFICATION) {
            showNotification("", apkUrl);
...
//            String updateMessage = data.getString("content");
