...
//            installAPKIntent.addFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
            ...
            showInstallAppActivity(apkFile);
...
//            start
     ...
     * @param apkPath
     */
    private void showInstallAppActivity(File apkPath){
        Intent installAPKIntent = new Intent(Intent.ACTION_VIEW);

        installAPKIntent.setDataAndType(Uri.fromFile(apkPath), "application/vnd.android.package-archive");
        installAPKIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        installAPKIntent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        installAPKIntent.addFlags(Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
